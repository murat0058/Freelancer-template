...
{
    public static class PageRender
    {
        internal static void GeneratePage()
        {
            string pContent = "";
            string hContent = "";
        ...
        /// <returns></returns>
        private static string[] RenderPortfolioItem(dynamic obj)
        {
        ...
        private static string RenderSocialIcon(dynamic obj)
        {
            if (obj["link"] != "")
            {
        ...
        private static string GetValue(string JsonKey, string Key, dynamic obj)
        {
